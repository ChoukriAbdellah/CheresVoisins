        ...
        <div id="page"> 
          ...
          <!--  partie principale -->  
			...
			<td>Description</td>
					...
					$req = 'SELECT refProd,nomProd,descProd,PUHTProd, categProd  FROM produits,categories WHERE categories.idCateg=produits.categProd AND libCateg="Guitares Classiques"'; //requete SQL pour recuperer les informations dans la bdd.
